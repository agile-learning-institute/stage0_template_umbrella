...
Now - let's use ``mh`` to start the whole system. Use ``mh up all`` and then visit [localhost:8080](http://localhost:8080/) and explore the system. When you are done exploring use ``mh down`` to stop all the containers. 
